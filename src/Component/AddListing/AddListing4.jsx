...
export default function AddListing4() {
  ...
  return (
    <>
      <div className="mt-5 md:mt-14 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-5 md:gap-10 xl:gap-20 mt-5 px-5 sm:px-10 md:px-14 lg:px-20 xl:px-24">
          {selectedImages.map((selectedImage, index) => (
            <div key={index}>
              <h2 className="text-[#818181]">{selectedImage.heading}</h2>
              <div className="rounded border-2 border-dashed border-black-500 p-4 mt-4">
                <label
        ...
        <div className="grid grid-cols-1 md:grid-cols-2  gap-5 md:gap-10 xl:gap-20 mt-5 px-5 sm:px-10 md:px-14 lg:px-20 xl:px-24">
          <div className="">
